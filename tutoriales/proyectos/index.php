        ...
        <section class="menu__container">
            ...
            <ul class="menu__links">
                ...
                <li class="menu__item menu__item--show">
                    ...
                    <ul class="menu__nesting">
                        <li class="menu__inside">
                            <a href="../../servicios/diseno_electronico_y_prototipado" class="menu__link menu__link--inside pagina-actual">Diseño Electrónico y Prototipado</a>
                        </li>
                        <li class="menu__inside">
                ...
                <li class="menu__item  menu__item--show">
                    ...
                    <ul class="menu__nesting">
                        <li class="menu__inside">
                            <a href="../electronica" class="menu__link menu__link--inside">Electrónica </a>
                        </li>
                        <li class="menu__inside">
...
<main class="contenedor sombra">
    <h2> DISEÑO Y PROTOTIPADO TECNOLOGIA</h2>
